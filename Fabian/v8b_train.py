...
# Gradient Checkpointing: spart ~50% Aktivierungs-Memory, kostet ~15% Speed.
# Mathematisch identisch zu V5 (gleiche Gewichte am Ende), nur Backward macht
# Re-Compute statt Activations zu speichern.
    ...
    for arch_idx, arch in enumerate(ARCH_LIST):
        ...
        for fold_idx, (train_idx, val_idx) in enumerate(splits):
            ...
            if USE_GRAD_CHECKPOINTING and hasattr(model, "set_grad_checkpointing"):
                ...
                log.info("  Gradient Checkpointing aktiviert")

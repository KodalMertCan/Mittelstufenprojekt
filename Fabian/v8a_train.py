...
ARCH_LIST = [
    {
        ...
        "img_size": 518,
        "batch_size": 16,        # V5-Performance, 4/GPU
        "grad_accum": 2,         # effektiv 32
        "lr": 1e-4,
...
# GPU 0 bekommt dann nur noch eine schlanke Modell-Replica.
MASTER_GPU = 1
...
if torch.cuda.is_available():
    ...
    # device_ids: Master zuerst, dann der Rest in Reihenfolge
    ...
    for arch_idx, arch in enumerate(ARCH_LIST):
        ...
        for fold_idx, (train_idx, val_idx) in enumerate(splits):
            ...
            if torch.cuda.device_count() > 1:
                # device_ids[0] = Master (= DEVICE). output_device = Master.
                # Dadurch traegt GPU 0 nur eine schlanke Replica und ist resistent
                # gegen Fremd-Workload (1.5 GB belegt).
